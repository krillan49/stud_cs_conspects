...
// Основная цель ООП-подхода это смоделировать предметную область той сферы деятельности, которую будет описывать наша программа
// 1. Анализ предметной области - нужно понять какие будут сущьности и какие между ними взаимосвязи
// 2. Придумать из каких частей будет состоять программа (классы, объекты)
// 3. Определить зону ответственности для каждого класса, чем более четко разделены зоны ответсвенности, чем меньше связанность, тем лучше
